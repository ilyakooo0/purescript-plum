                ...
                if (type === ".") {
                    ...
                    if (projectionOptions.namespace !== undefined) {
                        ...
                        domNode = vnode.domNode =
                            vnode.domNode ||
                                (((_a = vnode.properties) === null || _a === void 0 ? void 0 : _a.is) ? doc.createElement(found, { is: vnode.properties.is })
...
export function scheduleRender(projector) {
    return function () {
        projector.scheduleRender()
    }
}

export function replace(projector) {
    return function (el) {
